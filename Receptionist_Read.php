<?php
    ...
    while($row = $result->fetch_assoc()) {
        ...
        if ($row['id'] == $_GET['id']) {
            ...
            // Password
            echo '<td><label class="ml-4 mr-2" for="password"><b>Password:</b></label>';
            echo '<input type="text" name="password" id="Show_Password" class="form-control" value="'.$row['password'].'"></td>';
            
            // Rank           
            echo '<td><label class="ml-4 mr-2" for="rank"><b>Rank:</b></label>';
            echo '<input type="text" name="rank" id="Show_Rank" class="form-control" value="'.$row['rank'].'"></td>';
